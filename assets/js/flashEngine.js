/* ============================================================================
   security+  ::  flashEngine.js  —  Rapid Recall Flashcards
   ...
   - Cards live in lazy-loaded per-domain modules (assets/js/content/flashN.js),
     each populating ISC2CC.flash[N] with 100 cards { id, d, t, obj, front, back }.
   - Scheduling state persists to localStorage (ISC2CC.flash.v1) keyed by card id,
...
(function () {
  ...
  function ver() { return window.ISC2CC_VER ? "?v=" + window.ISC2CC_VER : ""; }
